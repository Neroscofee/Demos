...
//  Demos
//
//  Created by Neroscofee on 2017/11/21.
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ShowDynamicVC *menuVC = [[ShowDynamicVC alloc] init];
    menuVC.title = self.dataArray[indexPath.row];
    menuVC.type = (int)indexPath.row;
